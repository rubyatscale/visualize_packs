...
bundle exec visualize_packs --remote-base-url=https://github.com/shageman/visualize_packwerk/tree/main/spec/sample_app --no_nested_relationships > tests/no_nested_relationships.dot && dot tests/no_nested_relationships.dot -Tpng -o tests/no_nested_relationships.png
